...
for a in r: a.
print(graphLikePrinter, molLikePrinter)

postSection("Loaded Graphs")
for a in inputGraphs: a.
print()
postSection("Loaded Rules")
for a in inputRules: a.
print()
...
flowPathway.solutions.
print(flowPrinter)  # the argument is optional, see the top of the file for why we have it
...
flowAutocata.solutions.
print(flowPrinter)  # the argument is optional
